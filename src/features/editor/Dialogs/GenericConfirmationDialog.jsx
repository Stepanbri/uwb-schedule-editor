...
const GenericConfirmationDialog = ({
    ...
    return (
        <Dialog open={open} onClose={onClose} maxWidth="xs" fullWidth>
            <DialogTitle component="div"> {/* Zajistíme, že DialogTitle nerenderuje další h2 */}
                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                    <WarningAmberIcon sx={{ mr: 1, color: confirmButtonColor === 'error' ? 'error.main' : 'warning.main' }} />
                    <Typography variant="h6" component="span"> {/* Titulek je nyní span, ale vizuálně H6 */}
            ...
            <DialogActions sx={{ padding: '16px 24px' }}>
                <Button onClick={onClose}>{cancelButtonText || t('common.cancel', 'Cancel')}</Button>
